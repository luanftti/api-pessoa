                ...
                .cidade(Objects.isNull(this.cidadeNascimento) ? null
                        : Cidade.builder().id(this.cidadeNascimento.getId())
                                .pais(Objects.isNull(this.paisNascimento) ? null
                                        : Pais.builder().id(this.paisNascimento.getId()).build())
                                .build())
                .build();
    }
        ...
        try {
            return PessoaDTO.builder().id(entity.getId()).nome(entity.getNome()).cpf(entity.getCpf())
                    ...
                    .cidadeNascimento(Objects.isNull(entity.getCidade()) ? null
                            : (CidadeDTO) CidadeDTO.buildFromEntity(entity.getCidade(), CidadeDTO.class))
                    .paisNascimento(
                            Objects.isNull(entity.getCidade()) || Objects.isNull(entity.getCidade().getPais()) ? null
                                    : (PaisDTO) PaisDTO.buildFromEntity(entity.getCidade().getPais(), PaisDTO.class))
                    .build();
        } catch (Exception e) {
            return null;
        }
